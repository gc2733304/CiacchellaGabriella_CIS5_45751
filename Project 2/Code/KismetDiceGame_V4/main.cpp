 ...
 * Created on July 24, 2019, 11:22 PM
...
int main(int argc, char** argv) {
    ...
    int rndSum, dice, power, rndSum1, rndSum2;  //number of rounds, the round sum, round sum for each player, and the amount of dice
    ...
    else if (play == 2)  //Play the game against the computer
    {
        do
        {
            ...
            else 
            {
                ...
                cout<<"Ratio of longest to shorter game: "<<log10(end - beg)<<endl;
                cout<<"\nThank you for playing!"<<endl;
                totGame = 1;
            }
...
int display(int play)  //Function displays instructions and choice in beginning
{
